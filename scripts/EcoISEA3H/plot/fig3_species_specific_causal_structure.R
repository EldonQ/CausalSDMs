...
#       source("scripts/EcoISEA3H/plot/fig3_species_specific_causal_structure.R")
################################################################################
...
# 读取数据
# ══════════════════════════════════════════════════════════════════════════════
edges <- read.csv("output/case2_eco/all_dag_edges_v3.csv", stringsAsFactors = FALSE)
ate   <- read.csv("output/case2_eco/all_ate_results_v3.csv", stringsAsFactors = FALSE)
roles <- read.csv("output/case2_eco/all_role_info_v3.csv", stringsAsFactors = FALSE)
