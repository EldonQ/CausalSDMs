#!/usr/bin/env python3
"""
Fig 1: CAST technical roadmap (main paper) - Eco-ISEA3H version.
Adapted to output to figures/case2_eco/.
Run from project root: python scripts/EcoISEA3H/plot/fig1_cast_technical_roadmap_eco.py
"""
...
# Project root: script lives in scripts/EcoISEA3H/plot/
...
def main():
    ...
    ax.text(CX, iy + 0.28, 'Eco-ISEA3H Environmental Variables',
    ...
    fig.savefig(os.path.join(FIG_DIR, 'fig1_cast_technical_roadmap_eco.png'), dpi=1200,
                bbox_inches='tight', facecolor='white', edgecolor='none')
    print('[OK] fig1_cast_technical_roadmap_eco.png')
    fig.savefig(os.path.join(FIG_DIR, 'fig1_cast_technical_roadmap_eco.svg'), format='svg',
                bbox_inches='tight', facecolor='white', edgecolor='none')
    print('[OK] fig1_cast_technical_roadmap_eco.svg')
    plt.close()
