...
# ==============================================================================
# CAST v3 — Spatial Habitat Suitability Predictions for ALL Models
#
# Purpose:
...
#   suitability scores (HSS) on every hexagon in the full spatial grid.
#
# Output per species:
...
#
# This allows downstream plotting scripts (fig7) to freely choose which
# models to compare (e.g., CAST vs MLP, CAST vs RF, CAST vs Maxent, etc.)
#
# Input:
