################################################################################
# Fig S1 (Plant): Cross-Family Robustness — Supplementary
#   [Consolidates former fig5_cross_family_robustness_plant.R]
#
...
#      source("scripts/Plant/plot/figS1_cross_family_robustness.R")
################################################################################
...
# ── Load data ─────────────────────────────────────────────────────────────────
d <- read.csv("output/case4_plant/all_results_v3.csv",
...
figS1 <- pa / (pb | pc) +
    ...
    plot_annotation(
        title = "Fig S1 (Plant)  Cross-Family Robustness of CAST",
        subtitle = paste0(
...
ggsave(file.path(fig_dir, "figS1_cross_family_robustness_plant.png"),
    figS1,
    width = 14, height = 14, dpi = 300, bg = "white"
)
cat("Saved figS1_cross_family_robustness_plant.png\n")
