...
#
# Data required:
#   output/case4_plant/all_learning_curves_v3.csv
#   output/case4_plant/all_results_v3.csv
#
# Run: setwd("E:/CausalSDMs")
#      source("scripts/Plant/plot/figS3_training_curves.R")
################################################################################
...
# ── Load data ────────────────────────────────────────────────────────────────
lc <- read.csv("output/case4_plant/all_learning_curves_v3.csv",
